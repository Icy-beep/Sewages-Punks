...
SKIP_PROLOGUE_COMMANDS_YES = ['yes', 'y']
SKIP_PROLOGUE_COMMANDS_NO = ['no', 'n']
SKIP_PROLOGUE_COMMANDS =  [SKIP_PROLOGUE_COMMANDS_YES, SKIP_PROLOGUE_COMMANDS_NO]
...
MAIN_MENU_COMMANDS = [NEW_GAME_COMMANDS, LOAD_GAME_COMMANDS, SETTING_GAME_COMMANDS, EXIT_GAME_COMMANDS]
