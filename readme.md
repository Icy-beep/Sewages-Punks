...
<p align="center">
  <img src="C:\Users\user\PycharmProjects\Sewages-Punks\img\Main_menu_screen.png" width="600" style="border-radius: 15px; border: 2px solid #30363d;">
</p>
...
````diff
+ Procedural Generation: Генерация случайных уровней.
...
+ Exits: Ключи и двери для выхода из секторов и генерации новых.
+ Immersive: Вступление и сцена окончания игры.
````
